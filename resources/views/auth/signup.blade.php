...
<body class="bg-background text-on-background min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md bg-surface-container-low rounded-2xl p-8 border border-outline-variant shadow-sm flex flex-col gap-5">
        ...
        <div class="flex flex-col items-center gap-1 text-center">
            ...
            <h1 class="text-headline-md font-black text-primary tracking-tight mt-2">Get started with Focus</h1>
            <p class="text-body-md text-on-surface-variant">Create your free account to track your tasks</p>
        </div>

        <form action="/register" method="POST" class="flex flex-col gap-3.5" novalidate>
            @csrf

            <div class="flex flex-col gap-1">
                <label for="name" class="text-label-md font-bold text-on-surface">Full Name</label>
                <div class="relative">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                        class="w-full pl-10 pr-4 py-2 bg-surface border border-outline-variant rounded-xl text-body-md focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
            ...
            <div class="flex flex-col gap-1">
                <label for="password_confirmation" class="text-label-md font-bold text-on-surface">Confirm Password</label>
                <div class="relative">
                    <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-[20px]">lock_clock</span>
            ...
            <button type="submit" class="w-full bg-primary text-on-primary font-bold py-2.5 rounded-xl flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98] hover:opacity-95 transition-all mt-2">
        ...
        <div class="grid gap-3">
            <a href="#" class="flex items-center justify-center gap-2 py-2 border border-outline-variant rounded-xl hover:bg-surface-container transition-all active:scale-[0.98] font-medium text-body-md text-on-surface">
